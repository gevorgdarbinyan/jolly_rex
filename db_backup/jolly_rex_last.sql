...
INSERT INTO `tbl_entertainer` (`id`, `user_id`, `name`, `first_name`, `last_name`, `support_instant_booking`, `short_description`, `description`, `price_description`, `package_description`, `rating`, `phone_number`, `video`, `first_line_address`, `post_code`, `area`, `city`, `support_mileage`, `mileage_price`) VALUES
...
--
-- Table structure for table `tbl_entertainer_branches`
--
...
--
-- Dumping data for table `tbl_entertainer_branches`
--

INSERT INTO `tbl_entertainer_branches` (`id`, `first_line_address`, `post_code`, `area`, `city`, `note`, `entertainer_id`) VALUES
...
--
-- Table structure for table `tbl_entertainer_busy_schedule`
--
...
--
-- Dumping data for table `tbl_entertainer_busy_schedule`
--

INSERT INTO `tbl_entertainer_busy_schedule` (`id`, `entertainer_id`, `busy_date`, `busy_start_time`, `busy_end_time`, `reason`, `order_id`, `note`) VALUES
...
--
-- Table structure for table `tbl_entertainer_busy_schedule_staff`
--
...
--
-- Dumping data for table `tbl_entertainer_busy_schedule_staff`
--

INSERT INTO `tbl_entertainer_busy_schedule_staff` (`id`, `busy_schedule_id`, `entertainer_staff_id`, `creator_id`, `created_date`) VALUES
(1, 71, 1, NULL, NULL),
(2, 71, 2, NULL, NULL),
(3, 76, 2, NULL, NULL),
(4, 76, 3, NULL, NULL),
...
--
-- Table structure for table `tbl_entertainer_enquiries`
--
...
--
-- Dumping data for table `tbl_entertainer_enquiries`
--

INSERT INTO `tbl_entertainer_enquiries` (`id`, `customer_id`, `entertainer_id`, `option1_date`, `option1_start_time`, `option1_end_time`, `option2_date`, `option2_start_time`, `option2_end_time`, `option3_date`, `option3_start_time`, `option3_end_time`, `party_type_id`, `price`, `host_child_name`, `host_child_age`, `host_child_gender`, `special_requests`, `title`, `name`, `email`, `telephone_number`, `mobile_number`, `entertainers_count`, `first_line_address`, `post_code`, `area`, `city`, `status`, `theme_service_id`, `extra_option`, `additional_service_id`, `youngest_age`, `oldest_age`, `order_id`) VALUES
...
(25, 3, 18, '2019-06-12', '12:00:00', '13:00:00', '2019-06-13', '12:00:00', '13:00:00', '2019-06-14', '12:00:00', '13:00:00', 1, 355.54, 'Marwell', 3, 'male', 'blah blah', 'Mr', 'Yana Smith', 'yana.smith@yahoo.com', '+4423874562394', '+4423874562394', 2, '', NULL, '', '', 'confirmed', 8, 1, 14, NULL, NULL, 222);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_entertainer_enquiry_notifications`
--
...
--
-- Dumping data for table `tbl_entertainer_enquiry_notifications`
--

INSERT INTO `tbl_entertainer_enquiry_notifications` (`id`, `customer_id`, `entertainer_id`, `enquiry_id`, `note`, `creator_id`, `created_date`, `status`) VALUES
(2, 3, 18, 22, 'Entertainer chose the final date: 2019-05-17 13:00:00 - 14:00:00', NULL, '2019-05-12 17:20:18', 'active'),
(3, 3, 18, 22, 'fssfsdfsf', NULL, '2019-05-19 14:11:42', 'pending'),
(4, 3, 18, 22, 'test test test', 102, '2019-05-19 14:14:14', 'pending'),
(5, 3, 18, 23, ' Hi,\n\nIt is not convenient for us selected date times both.\n Our entertainers are busy all these date times.\nLet us share all convenient dates for us:\nMay 20, 2019, 17 : 30 - 18:30\nMay 22, 2019, 16 : 00 - 18: 30\n June 05, 2019, at 16:30 - 18:30\n\nRegards,\nEntertainer 2 Team\n                                ', NULL, '2019-05-19 14:45:12', 'pending'),
(6, 3, 18, 23, 'OK no problem', 102, '2019-05-19 14:55:33', 'pending'),
(7, 3, 18, 24, 'Entertainer chose the final date: 2019-05-25 12:00:00 - 15:00:00', NULL, '2019-05-19 21:03:55', 'active'),
(8, 3, 18, 25, 'Entertainer chose the final date: 2019-06-14 12:00:00 - 13:00:00', NULL, '2019-06-01 15:25:23', 'active');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_entertainer_enquiry_prices`
--
...
--
-- Dumping data for table `tbl_entertainer_enquiry_prices`
--

INSERT INTO `tbl_entertainer_enquiry_prices` (`id`, `entertainer_id`, `customer_id`, `enquiry_id`, `entertainer_service_id`, `extra_guest_count`, `service_type`) VALUES
(1, 18, 3, 1, 12, 0, 'theme'),
(2, 18, 2, 2, 12, 0, 'theme'),
(3, 18, 3, 3, 28, 0, 'theme'),
(4, 18, 3, 4, 12, 0, 'theme'),
...
--
-- Table structure for table `tbl_entertainer_orders`
--
...
(46, 18, 222, 1, 8, 0, NULL, '2019-06-14', '12:00:00', '13:00:00', 2, 'blah blah', NULL, NULL, 3, 'male', 'Marwell', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Pending', 3, 'Unacknowledged', 25);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_entertainer_orders_staff`
--
...
--
-- Dumping data for table `tbl_entertainer_orders_staff`
--

INSERT INTO `tbl_entertainer_orders_staff` (`id`, `entertainer_order_id`, `entertainer_staff_id`, `creator_id`, `created_date`) VALUES
...
--
-- Table structure for table `tbl_entertainer_order_prices`
--
...
--
-- Dumping data for table `tbl_entertainer_order_prices`
--
...
--
-- Table structure for table `tbl_entertainer_packages`
--
...
--
-- Dumping data for table `tbl_entertainer_packages`
--
...
--
-- Table structure for table `tbl_entertainer_party_themes`
--
...
--
-- Dumping data for table `tbl_entertainer_party_themes`
--
...
--
-- Table structure for table `tbl_entertainer_photos`
--
...
--
-- Dumping data for table `tbl_entertainer_photos`
--
...
--
-- Table structure for table `tbl_entertainer_postal_codes`
--
...
--
-- Dumping data for table `tbl_entertainer_postal_codes`
--

INSERT INTO `tbl_entertainer_postal_codes` (`id`, `entertainer_id`, `postal_code_id`, `creator_id`, `created_date`) VALUES
(1, 2, 39, 1, NULL),
(2, 2, 17, 1, NULL),
(3, 2, 61, 1, NULL),
(4, 18, 39, 1, NULL),
...
--
-- Table structure for table `tbl_entertainer_services`
--
...
--
-- Dumping data for table `tbl_entertainer_services`
--

INSERT INTO `tbl_entertainer_services` (`id`, `entertainer_id`, `service_id`, `duration`, `count_of_guests`, `price`, `extra_guest_count`, `entertainers_count`) VALUES
...
--
-- Table structure for table `tbl_entertainer_staff`
--
...
--
-- Dumping data for table `tbl_entertainer_staff`
--

INSERT INTO `tbl_entertainer_staff` (`id`, `first_name`, `last_name`, `photo`, `entertainer_id`, `date`, `start_time`, `end_time`, `day`) VALUES
...
--
-- Table structure for table `tbl_food_item_photos`
--
...
--
-- Dumping data for table `tbl_food_item_photos`
--
...
--
-- Table structure for table `tbl_food_photos`
--
...
--
-- Dumping data for table `tbl_food_photos`
--
...
INSERT INTO `tbl_orders` (`id`, `customer_id`, `status`, `price`, `entertainer_id`, `venue_id`, `food_id`, `product_id`, `creator_id`, `created_date`, `order_type`) VALUES
(10, 3, 'unacknowlegded', 500, 2, 0, 0, 0, 3, '2018-02-18 03:51:27', 'order'),
...
(222, 3, 'Unacknowledged', 355.54, 18, NULL, 0, 0, NULL, '2019-06-01 19:25:23', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_order_food_items`
--
...
--
-- Dumping data for table `tbl_order_food_items`
--

INSERT INTO `tbl_order_food_items` (`id`, `order_id`, `food_id`, `food_item_id`, `count`, `price`, `size`, `people_count`, `message_on`, `color_message_on`, `font_message_on`, `note`, `when_will_be_ready`) VALUES
...
--
-- Table structure for table `tbl_order_product_items`
--
...
--
-- Dumping data for table `tbl_order_product_items`
--
...
--
-- Table structure for table `tbl_party_theme`
--
...
--
-- Dumping data for table `tbl_party_theme`
--
...
--
-- Table structure for table `tbl_party_type`
--
...
--
-- Dumping data for table `tbl_party_type`
--
...
INSERT INTO `tbl_postal_codes` (`id`, `abbr`, `name`, `postal_code_direction_id`) VALUES
...
--
-- Table structure for table `tbl_postal_code_directions`
--
...
--
-- Dumping data for table `tbl_postal_code_directions`
--

INSERT INTO `tbl_postal_code_directions` (`id`, `name`) VALUES
(1, 'North London'),
(2, 'South London'),
(3, 'East London'),
(4, 'West London'),
...
--
-- Table structure for table `tbl_product_item_photos`
--
...
--
-- Dumping data for table `tbl_product_item_photos`
--
...
--
-- Dumping data for table `tbl_product_photos`
--
...
INSERT INTO `tbl_reviews` (`id`, `customer_id`, `supplier_id`, `comment`, `order_id`, `entertainers_point`, `overall_program_point`, `keep_anonymous`, `admin_id`) VALUES
...
(2, 'entertainer@gmail.com', '63ee451939ed580ef3c4b6f0109d1fd0', 'Active', 2, 1, 5, 'fisher', ''),
...
--
-- Dumping data for table `tbl_user_photos`
--
...
INSERT INTO `tbl_venue` (`id`, `user_id`, `name`, `short_description`, `description`, `rating`, `price`, `postal_code`, `support_instant_booking`, `address`) VALUES
...
--
-- Table structure for table `tbl_venue_options`
--
...
--
-- Dumping data for table `tbl_venue_options`
--
...
--
-- Table structure for table `tbl_venue_orders`
--
...
--
-- Dumping data for table `tbl_venue_orders`
--

INSERT INTO `tbl_venue_orders` (`id`, `venue_id`, `order_id`, `price`, `event_date`, `start_time`, `end_time`, `customer_id`) VALUES
(1, 6, 10, 700, '2019-01-31', '10:30:00', '11:30:00', 3);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_venue_photos`
--
...
--
-- Dumping data for table `tbl_venue_photos`
--
...
--
-- Indexes for table `tbl_entertainer_branches`
--
ALTER TABLE `tbl_entertainer_branches`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_entertainer_busy_schedule`
--
ALTER TABLE `tbl_entertainer_busy_schedule`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_entertainer_busy_schedule_staff`
--
ALTER TABLE `tbl_entertainer_busy_schedule_staff`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_entertainer_enquiries`
--
ALTER TABLE `tbl_entertainer_enquiries`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_entertainer_enquiry_notifications`
--
ALTER TABLE `tbl_entertainer_enquiry_notifications`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_entertainer_enquiry_prices`
--
ALTER TABLE `tbl_entertainer_enquiry_prices`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_entertainer_orders`
--
ALTER TABLE `tbl_entertainer_orders`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_entertainer_orders_staff`
--
ALTER TABLE `tbl_entertainer_orders_staff`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_entertainer_order_prices`
--
ALTER TABLE `tbl_entertainer_order_prices`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_entertainer_packages`
--
ALTER TABLE `tbl_entertainer_packages`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_entertainer_party_themes`
--
ALTER TABLE `tbl_entertainer_party_themes`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_entertainer_photos`
--
ALTER TABLE `tbl_entertainer_photos`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_entertainer_postal_codes`
--
ALTER TABLE `tbl_entertainer_postal_codes`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_entertainer_services`
--
ALTER TABLE `tbl_entertainer_services`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_entertainer_staff`
--
...
--
-- Indexes for table `tbl_food_item_photos`
--
ALTER TABLE `tbl_food_item_photos`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_food_photos`
--
...
--
-- Indexes for table `tbl_order_food_items`
--
ALTER TABLE `tbl_order_food_items`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_order_product_items`
--
ALTER TABLE `tbl_order_product_items`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_party_theme`
--
ALTER TABLE `tbl_party_theme`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_party_type`
--
...
--
-- Indexes for table `tbl_postal_code_directions`
--
ALTER TABLE `tbl_postal_code_directions`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tbl_product_item_photos`
--
ALTER TABLE `tbl_product_item_photos`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_product_photos`
--
...
--
-- Indexes for table `tbl_venue_options`
--
ALTER TABLE `tbl_venue_options`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_venue_orders`
--
ALTER TABLE `tbl_venue_orders`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_venue_photos`
--
...
--
-- AUTO_INCREMENT for table `tbl_entertainer_branches`
--
ALTER TABLE `tbl_entertainer_branches`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbl_entertainer_busy_schedule`
--
ALTER TABLE `tbl_entertainer_busy_schedule`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;

--
-- AUTO_INCREMENT for table `tbl_entertainer_busy_schedule_staff`
--
ALTER TABLE `tbl_entertainer_busy_schedule_staff`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `tbl_entertainer_enquiries`
--
ALTER TABLE `tbl_entertainer_enquiries`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `tbl_entertainer_enquiry_notifications`
--
ALTER TABLE `tbl_entertainer_enquiry_notifications`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tbl_entertainer_enquiry_prices`
--
ALTER TABLE `tbl_entertainer_enquiry_prices`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `tbl_entertainer_orders`
--
ALTER TABLE `tbl_entertainer_orders`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT for table `tbl_entertainer_orders_staff`
--
ALTER TABLE `tbl_entertainer_orders_staff`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `tbl_entertainer_order_prices`
--
ALTER TABLE `tbl_entertainer_order_prices`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT for table `tbl_entertainer_packages`
--
ALTER TABLE `tbl_entertainer_packages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbl_entertainer_party_themes`
--
ALTER TABLE `tbl_entertainer_party_themes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT for table `tbl_entertainer_photos`
--
ALTER TABLE `tbl_entertainer_photos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tbl_entertainer_postal_codes`
--
ALTER TABLE `tbl_entertainer_postal_codes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tbl_entertainer_services`
--
ALTER TABLE `tbl_entertainer_services`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT for table `tbl_entertainer_staff`
--
ALTER TABLE `tbl_entertainer_staff`
...
--
-- AUTO_INCREMENT for table `tbl_food_item_photos`
--
ALTER TABLE `tbl_food_item_photos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tbl_food_photos`
--
ALTER TABLE `tbl_food_photos`
...
--
-- AUTO_INCREMENT for table `tbl_order_food_items`
--
ALTER TABLE `tbl_order_food_items`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbl_order_product_items`
--
ALTER TABLE `tbl_order_product_items`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_party_theme`
--
ALTER TABLE `tbl_party_theme`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `tbl_party_type`
--
ALTER TABLE `tbl_party_type`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT for table `tbl_postal_code_directions`
--
ALTER TABLE `tbl_postal_code_directions`
...
--
-- AUTO_INCREMENT for table `tbl_product_item_photos`
--
ALTER TABLE `tbl_product_item_photos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tbl_product_photos`
--
ALTER TABLE `tbl_product_photos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `tbl_venue_options`
--
ALTER TABLE `tbl_venue_options`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tbl_venue_orders`
--
ALTER TABLE `tbl_venue_orders`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_venue_photos`
--
ALTER TABLE `tbl_venue_photos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Constraints for table `tbl_user_photos`
--
ALTER TABLE `tbl_user_photos`
