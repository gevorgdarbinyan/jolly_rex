    ...
    foreach ($entertainerPriceData as $priceData) {
        ...
        $str .= Html::beginTag('tr');
            $str .= Html::beginTag('td',['style'=>'font-size:16px;']);
                ...
                $str .= Html::hiddenInput('extra_guest_count[]', $priceData['extra_guest_count'], ['class' => 'theme-service-extra-guest-count-class']);
                $str .= Html::hiddenInput('entertainers_count[]', $priceData['entertainers_count'], ['class' => 'theme-service-entertainers-count-class']);
            $str .= Html::endTag('td');
...
$str .= Html::beginTag('table', ['class'=>'table table-bordered table-striped']);
    ...
    $str .= Html::beginTag('tr');
        ...
        $str .= Html::endTag('td');
        $str .= Html::beginTag('td');
            $str .= Html::textInput('youngest_age', '', ['class' => 'form-control youngest-age-class']);
        $str .= Html::endTag('td');
    $str .= Html::endTag('tr');
    ...
    $str .= Html::beginTag('tr');
        ...
        $str .= Html::endTag('td');
        $str .= Html::beginTag('td');
            $str .= Html::textInput('oldest_age', '', ['class' => 'form-control oldest-age-class']);
        $str .= Html::endTag('td');
    $str .= Html::endTag('tr');
$str .= Html::endTag('table');
echo $str;
