...
$this->registerCssFile("@web/css/entertainers/book/index.css");
$this->registerJsFile('@web/js/entertainer/book/index.js', ['position' => View::POS_END, 'depends' => [\yii\web\JqueryAsset::className()]]);
...
<div class="container-fluid">
    <div class="wrapper">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 calendar_class">
            <nav id="sidebar">
                <?= $this->render('_sidebar', ['entertainerData' => $entertainerData,'entertainerExtraThemeServices' => $entertainerExtraThemeServices,
