$(document).ready(function () {
    ...
    $(document).on('change', '.theme-service-price-class', function(){
        var existTotal = Number($('.total-price').html());
        console.log(existTotal);
        var themeServicePrice = countThemeServicePriceSum();
        console.log(themeServicePrice);
        var total = existTotal + themeServicePrice;
        $('.total-price').html(total);
    });

    $(document).on('change', '.additional-services-price-class', function(){
        var existTotal = Number($('.total-price').html());
        var additionalServicePrice = countAdditionalServicePriceSum();
        var total = existTotal + additionalServicePrice;
        $('.total-price').html(total);
    });
